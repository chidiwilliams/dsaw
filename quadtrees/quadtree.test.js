const { Node, Point, Quadtree, Boundary } = require('./quadtree');
...

{
  ...
  const n1 = new Node(new Point(1, 1), '1');
  const n2 = new Node(new Point(2, 2), '2');
  const n3 = new Node(new Point(4, 4), '2');
  const n4 = new Node(new Point(6, 6), '4');
